...
public class QuestionService {
    ...
    public static List<Option> getOptionsFromJson(String jsonOptions, String jsonAnswer) throws IllegalAccessException, JSONException, InstantiationException {
        JsonConverter<Option> converter = new JsonConverter<>(Option.class);
        List<Option> options = converter.getArray(jsonOptions);
        List<Integer> answerIds = new ArrayList<>();
        JSONArray array = (JSONArray) (new JSONTokener(jsonAnswer)).nextValue();
